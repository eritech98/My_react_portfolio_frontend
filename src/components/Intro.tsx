          ...
          <div id="home" style={gradientBackground}>
            <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
              <Row gutter={[48, 48]} align="middle">
                ...
                <Col xs={24} md={12}>
                  <Space direction="vertical" size="large" style={{ width: "100%" }}>
                    <Title level={1} style={{ color: "#fff", margin: 0, fontSize: "2.5rem", lineHeight: 1.2 }}>
                      Crafting Digital Excellence
                    </Title>
                    <Paragraph style={{ color: "#fff", opacity: 0.8, fontSize: "1rem" }}>
                    ...
                    <Space>
                      ...
                      <Button size="large" ghost icon={<HeartOutlined />} href="#contact">
                        Get in Touch
                      </Button>
                    </Space>
                  </Space>
