...
const Caro: React.FC = () => {
  ...
  const meteorologyProjects = [
    ...
    },
    {
      ...
      image: '/public/assets/proEase.PNG',
    ...
    { id: 3, title: 'SkyHire Aircraft Rental Platform', 
      ...
      image: '/public/assets/skyHire.PNG', 
  ...
  "projectLink": "https://example.com/erick-portfolio",
  "features": [
...
,
  ...
  "image": "/public/assets/client.PNG",
...
,
  ...
  "image": "/public/assets/Chatai2.PNG",
